...
* `timm.models.layers` moved to `timm.layers`:
  * `from image_models.timm.models.layers import name` will still work via deprecation mapping (but please transition to `timm.layers`).
  * `import timm.models.layers.module` or `from image_models.timm.models.layers.module import name` needs to be changed now.
