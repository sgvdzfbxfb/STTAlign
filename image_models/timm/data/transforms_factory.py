...
from image_models.timm.data.constants import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, DEFAULT_CROP_PCT
from image_models.timm.data.auto_augment import rand_augment_transform, augment_and_mix_transform, auto_augment_transform
from image_models.timm.data.transforms import str_to_interp_mode, str_to_pil_interp, RandomResizedCropAndInterpolation,\
    ResizeKeepRatio, CenterCropOrPad, ToNumpy
from image_models.timm.data.random_erasing import RandomErasing
...
def create_transform(
    ...
    if tf_preprocessing and use_prefetcher:
        ...
        from image_models.timm.data.tf_preprocessing import TfPreprocessTransform
