...
from image_models.timm.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame
from image_models.timm.layers.non_local_attn import BilinearAttnTransform
from image_models.timm.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
from image_models.timm.layers.norm_act import (
    BatchNormAct2d,
    SyncBatchNormAct,
...
# NOTE: By default, any modules from image_models.timm.models.layers that we want to treat as leaf modules go here
# BUT modules from image_models.timm.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from image_models.timm.layers import InplaceAbn
