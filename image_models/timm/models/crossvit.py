...
"""
Modifed from image_models.timm. https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
...
from image_models.timm.layers import DropPath, to_2tuple, trunc_normal_, _assert
